...
DLP_SH="$PROJECT_DIR/yt-dlp/Downloading_from_YouTube_v18.sh"
DLP_PS1="$PROJECT_DIR/yt-dlp/Downloading_from_YouTube_v18.ps1"
DLP_CMD="$PROJECT_DIR/yt-dlp/Downloading_from_YouTube_v18.cmd"
