...
# ══════════════════════════════════════════════════════════════
SH_SRC="$(cat "$PROJECT_DIR/yt-dlp/Downloading_from_YouTube_v18.sh")"
CMD_SRC="$(cat "$PROJECT_DIR/yt-dlp/Downloading_from_YouTube_v18.cmd")"
PS1_SRC="$(cat "$PROJECT_DIR/yt-dlp/Downloading_from_YouTube_v18.ps1")"
